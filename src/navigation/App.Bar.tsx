...
import { HrViewPage } from "../pages/hr-view/hr-view";
import { UserViewPage } from "../pages/user-view/user-view";
import { ReportViewPage } from "../pages/reports-view/reports-view";
import { AddRequirementPage } from "../pages/new-requirement/component";
    ...
    return (
      <div className={classes.root}>
        ...
        <main className={classes.content}>
          ...
          <Route path="/hrview" component={HrViewPage} />
          <Route path="/userview" component={UserViewPage} />
          <Route path="/reports" component={ReportViewPage} />
          <Route path="/add-requirement" component={AddRequirementPage} />
          {this.renderAlert()}
          {this.renderSpinner()}
        </main>
      </div>
